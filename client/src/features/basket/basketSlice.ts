...
//to make it asyncrenous use createAsyncThunk
//export const async function = createAsyncThunk....
...
export const removeBasketItemAsync = createAsyncThunk<void, {productId:number,quantity:number, name?:string}>(
    ...
    async ({productId,quantity},thunkAPI) => {     // async method
        try {
